...
while (dinero > 0 && apuesta >0)	// si la apuesta es cero, acaba el juego.
{
    ...
    let num = prompt("A que número quiere apostar, del 1 al 6 ", "1"); numero = parseInt(num);

    let cantidad = prompt("Cantidad que quiere apostar ", "20"); apuesta = parseInt(cantidad);
